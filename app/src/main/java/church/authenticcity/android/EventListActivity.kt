...
class EventListActivity : AppCompatActivity() {
    ...
    companion object {
        fun start(context: Context, appearance: AuthenticAppearance.Events) {
            start(context, appearance.title)
        }

        fun start(context: Context, title: String) {
            context.startActivity(Intent(context, EventListActivity::class.java).apply { putExtra("title", title) })
        }
    }
    ...
    private val eventsEventListener = object : ValueEventListener {
