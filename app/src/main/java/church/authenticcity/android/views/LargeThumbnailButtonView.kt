...
import church.authenticcity.android.databinding.ThumbnailButtonLargeViewBinding
...
class LargeThumbnailButtonView private constructor(context: Context) : RelativeLayout(context) {
    private val binding = ThumbnailButtonLargeViewBinding.inflate(LayoutInflater.from(context), this, true)
    ...
    private fun initialize(resource: ImageResource) {
        ...
        binding.labelBackground.setBackgroundColor(Color.argb(208, 0, 0, 0))
        ...
        binding.thumbnail.layoutParams = LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, resource.calculateHeight(resources.displayMetrics.widthPixels - widthMargin))
    }
}