 ...
 */
class AuthenticEventPlaceholder(id: String, val index: Int, title: String, hideTitle: Boolean, header: ImageResource, private val elements: List<HashMap<String, Any>>?, val action: ButtonAction?) : AuthenticEvent(id, title, hideTitle, "", header, HashMap<String, Any>().apply {
